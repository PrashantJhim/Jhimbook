...
import Link from 'next/link'
 ...
 let Menu = (props) =>{
    ...
    let IconCheck = () =>{
        ...
        if (Icon == 'Create'){
            document.getElementById('/Profile').style.border = '0px'
            ChangeCreate('Create1.svg')
            ChangeHome('Home.svg')
    ...
    return (
        ...
        <Link href = '/Create'  ><a><img className = ' mt-0 ml-5 h-7'  src = {CreateIcon}/></a></Link>
        <Link href = '/Home'  ><a><img className = 'ml-5 h-7'  src = {HomeIcon}/></a></Link>
        <Link href = '/Message' ><a><img className = 'ml-5 h-7'  src = {MessageIcon}/></a></Link>
        <Link href = '/Like'  ><a><img className = 'ml-5 h-8' src = {LikeIcon}/></a></Link>
        ...
        <Link href = '/EditProfile'><button className = 'font-Secondary hover:text-red-600 text-lg border-b border-black'>Setting</button></Link>
